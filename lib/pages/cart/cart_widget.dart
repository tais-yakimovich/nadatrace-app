        ...
        children: [
          Align(
            ...
            child: FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('CART_PAGE_arrow_back_ICN_ON_TAP');
                ...
                children: [
                                                  ...
                                                  child:
                                                    ...
                                                    updateCount: (count) async {
                                                      safeSetState(() => _model
                                                          ...
                                                          count);
                                                      logFirebaseEvent(
                                                          'CART_CountController_fn9rrcry_ON_FORM_WI');
                                                      logFirebaseEvent(
                                                          'CountController_update_page_state');
                                                      _model.numBags = _model
                                                          .countControllerValue!;
                                                      safeSetState(() {});
                                                    },
                                                    stepSize: 1,
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent('CART_PAGE_checkout_ON_TAP');
                        logFirebaseEvent('checkout_navigate_to');

                        context.goNamed(CheckoutConfirmationWidget.routeName);
                      },
                      text: 'checkout',
